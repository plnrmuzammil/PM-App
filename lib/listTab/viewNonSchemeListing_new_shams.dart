...
class ViewNonSchemeListingNew extends StatefulWidget {
  const ViewNonSchemeListingNew({Key? key, this.scheme}) : super(key: key);


  final scheme;

  @override
  State<ViewNonSchemeListingNew> createState() => _ViewNonSchemeListingState();
}

class _ViewNonSchemeListingState extends State<ViewNonSchemeListingNew> {
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                (documents[index].data() as Map<String, dynamic>)['schemeImageURL'] == "" ?
                                CircleAvatar(
                                  radius: 40,
                                  backgroundImage: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5V0xbLGXgCE5b9LrnrrawNIaYO6qsZxBxRxkOI9yKtA&s"),
                                ) : CircleAvatar(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                "${(documents[index].data()as Map<String,dynamic>)["name"]}",
                                                textAlign:
                                                TextAlign
                                                    .left,
                                                style:const TextStyle(
